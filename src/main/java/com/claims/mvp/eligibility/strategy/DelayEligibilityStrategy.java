...
/**
 * EU 261/2004 eligibility for flight delays.
 *
 * Eligible when:
 *  - flight is in scope (departs from EU OR carrier is EU);
 *  - the delay is not caused by extraordinary circumstances;
 *  - delay is at least 180 minutes (3 hours).
 *
 * Compensation amount is derived from flight distance:
...
@Component
public class DelayEligibilityStrategy implements EligibilityStrategy{
